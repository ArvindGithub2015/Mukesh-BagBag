...
public class BottomNavigationBar implements View.OnClickListener {
    ...
    public BottomNavigationBar(Context mContext, List<NavigationPage> pages, BottomNavigationMenuClickListener listener) {
        ...
        this.mLLBar5 = (LinearLayout) mActivity.findViewById(R.id.gold);
        ...
        this.mViewBar5 = (View) mActivity.findViewById(R.id.goldBar);
        ...
        this.mImageViewBar5 = (AppCompatImageView) mActivity.findViewById(R.id.goldImage);
        ...
        this.mTextViewBar5 = (AppCompatTextView) mActivity.findViewById(R.id.goldText);
    ...
    private void setView(View view) {
        ...
        if (view.getId() == R.id.linearLayoutBar1) {
           ...
           // this.mLLBar5.setBackgroundColor(mContext.getResources().getColor(R.color.gold));
            this.mImageViewBar5.setColorFilter(ContextCompat.getColor(mContext, R.color.gold));
            //this.mImageViewBar5.setImageResource(R.drawable.crow_on);
            this.mTextViewBar5.setTextColor(ContextCompat.getColor(mContext, R.color.gold));
            return;
        } else {
            return;
        }
    ...
    public void updateBottomMenuOnDemand(int index){
