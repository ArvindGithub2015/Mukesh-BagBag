...
package zuzusoft.com.bagbag.custom_views.crop_view;
...
public class CropImageActivity extends AppCompatActivity
    ...
    private ImageView cropCancel, btnBack;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // float xCoord = mCropImageView.getX();


        mCropImageView = findViewById(R.id.cropImageView);
        mCropImageView.setAspectRatio(1,1);
        //mCropImageView.setCropRect(new Rect(0, 0, 500, 500));

        saveButton = (FrameLayout) findViewById(R.id.saveButton);
        saveButtonListener();

        cropCancel = (ImageView) findViewById(R.id.cropCancel);
        btnBack = (ImageView) findViewById(R.id.btnBack);
        closeCropWindowListener(btnBack);
        closeCropWindowListener(cropCancel);
    ...
    private void closeCropWindowListener(ImageView btnBack) {
